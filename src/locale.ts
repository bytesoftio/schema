export let locale = {
  ...
  "array_optional": "Must be an array",
  ...
  "boolean_required": "Must be a boolean",
  "boolean_optional": "Must be a boolean",
  "boolean_equals": `Must be equal to "$1"`,

  "date_required": "Must be a date",
  ...
  "mixed_required": "Must be a boolean",
  "mixed_optional": "Must be a boolean",
  ...
  "number_optional": "Must be a number",
