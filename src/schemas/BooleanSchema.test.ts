...
describe("BooleanSchema", () => {
  test("required", async () => {
    ...
    expect((await s1.validateAsync(null))![0].message).toBe(translateMessage("boolean_required"))
  ...
  test("optional", async () => {
    ...
    expect((await s.validateAsync(1))![0].message).toBe(translateMessage("boolean_optional"))
